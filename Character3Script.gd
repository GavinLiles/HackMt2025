...
func shoot():
	...
	bullet.global_position = $GunMuzzle3.global_position  # Start from gun muzzle
	var shoot_direction = (locked_cord - $GunMuzzle3.global_position).normalized()
